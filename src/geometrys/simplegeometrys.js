...
// 1. Define Geometries 
const Referanceplanegeometry = new THREE.PlaneGeometry(100,100,10,10);
...
const cubematerial = new THREE.MeshStandardMaterial({ color: "skyblue",metalness: 0.5, roughness: 0.5 });
